...
from llama_index.core import Settings, StorageContext, DocumentSummaryIndex
...
embed_model = OllamaEmbedding(
    model_name=os.getenv("LLAMA_EMBED_MODEL_NAME"),
    embed_batch_size=50)
llm = Ollama(
...
docs_summary_index = DocumentSummaryIndex.from_documents(
    docs,
    storage_context=storage_context,
    summary_query="用中文描述所给文本的主要内容，同时描述这段文本可以回答的一些问题")
pprint.pprint(docs_summary_index.get_document_summary("doc1"))
